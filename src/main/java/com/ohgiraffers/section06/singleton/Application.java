...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   2. 동시성 문제를 고려해서 설게해야 하기 때문에 난이도가 있다.
        *  */

        /* 필기.
        *   싱글톤 구현 방법
        *   1. 이른 초기화 (Early Initioalization)
...
//        int b = 10; // 이른 초기화
        ...
        /* 목차. 1. 이른 초기화 구현 */
        // 필기. 생성자를 이용하여 인스턴스 생성을 막고 getInstance () 메소드를 호출해냐 인스턴스 생성 가능
//        EagerSingleton eager = new EagerSingleton(); 생성자가 private 이기 떄문에 접근 불가.
        ...
        *   게으른 초기화를 사용하면 첫 번째 요청에 대한 속도가 두 번쨰 요청에 대한
        *   속도보다 느리다.
