...
public class OverloadingTest {
    ...
    *   이 떄, 동일한 기능의 메소드를 매개변수에 따라 다르게 이름을 정의하면 복잡하고
    *   관리하기가 매우 어려울 것이다.
    ...
    *  */
    ...
    /* 필기.
    *   오버로딩의 조건
    *   동일한 이름을 가진 메소드의 피라미터 선언부에 매개변수 타입, 갯수, 순서를
    *   다르게 작성하여 한 클래스 내에 동일한 이름의 메소드를 여러 개 작성할 수 있다.
    *   메소드의 시그니쳐가 다르면 다른 메소드로 인식하기 떄문이다.
    *   즉 시그니쳐 중 메소드 이름은 동일해야 하기 떄문에
    *   피라미터(매개변수) 선언부가 다르게 작성되어야 오버로딩이 성립된다.
    *  */

    /* 필기
    *   메소드의 시그니처란?
    *   public void method(int num){} 이라는 메소드의 메소드명과 피라미터 선언부 부분을 시그니쳐라고 한다.
...
//    public int test(){return 0;}
    ...
    public void test(int num){} // 매개변수 선언부도 포함을 해서 시그니처에 해당하기 떄문에 오류가 되지 않는다.
