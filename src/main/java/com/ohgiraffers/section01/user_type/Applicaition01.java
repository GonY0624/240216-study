...
public class Applicaition01 {
    ...
    public static void main(String[] args) {
        ...
        *   */
        ...
        int age = 26;
        char gender = '여';
        String[] hobby = new String[]{"헬스", "영화", "넷플릭스"};
        ...
        *  */
        ...
        /* 필기.
        *   자료형 변수명 = new 클래스명(); <- 지금까지 사용한 이 구문은 객체 (intstance) 를 생성하는 구문이다.
        *   사용자 정의의 자료형인 클래스를 이용하기 위해서는 new 연산자로 heap 공간에 할당을 해야한다.
        *   객체를 생성하게 되면 클래스에 정의한 필드와 메소드 대로 객체(instance) 가 생성된다.
        *   아이다, 비밀번호, 이름, 나이, 성별, 취미를 연속된 메모리 공간(주소) 에서 사용하도록 동간을 만들었다.
        ...
        *  */
        ...
        /* 필기.
        *   필드에 접근하기 위해서는 래퍼런스 변수명.필드명 <- 이렇게 접근한다.
        *   ' . ' 참조연산자 라고 하는데, 래퍼런스 변수가 참조하고 있는 주소로 접근한다 라는 의미.
        *   각 공간은 필드명으로 접근한다.
        *   */

        System.out.println("member.id : " + member.id);
        System.out.println("member.psw : " + member.pwd);
