...
public class Application {
    ...
    /* 수업목표. 초기화 블록의 동작 순서를 이해하고 이를 활용하여 인스턴스를 생성할 수 있다.
    *           안중요 */
    ...
    *         인스턴스 변수를 초기화 하며, 정적 필드에는 실행 시점마다 값을 덮어쓴다.
    *   {
    *       초기화 내용 작성
    *   }
    *   2. 정적 초기화 블럭
    *       : 클래스가 로드 될 떄 한 번 동작한다.
    *         정적필드를 초기화 하며 인스턴스 변수는 초기화 하지 못한다.
    *   static {
    *           초기화 내용 작성
    *   }
    *
...
//        System.out.println(product.getIngo());
        ...
        Product product2 = new Product("대륙폰", 3000, "샤오미");
        System.out.println(product2.getIngo());
